...
const G = {
  ...
  // ── UI-иконки ──
  lotus:   ['#d06a98', '<path d="M12 18c-2-1.5-4-4-4-6.5C8 9 10 7 12 5c2 2 4 4 4 6.5 0 2.5-2 5-4 6.5z"/><path d="M12 18c-3.5-1-6-3-7-5.5 1.5-.5 3.5 0 5 1.5"/><path d="M12 18c3.5-1 6-3 7-5.5-1.5-.5-3.5 0-5 1.5"/>'],
  offline: ['#6783a3', '<circle cx="12" cy="18" r="1.5"/><path d="M8.5 15c1-.8 2.2-1.2 3.5-1.2s2.5.4 3.5 1.2"/><path d="M5.5 12c1.8-1.5 4-2.3 6.5-2.3s4.7.8 6.5 2.3"/><path d="M3 9c2.5-2 5.5-3.2 9-3.2s6.5 1.2 9 3.2"/>'],
  speaker: ['#e0852f', '<path d="M8 9.5v5l4 3V6.5l-4 3z"/><path d="M15 9.5c.8.8 1.2 1.5 1.2 2.5s-.4 1.7-1.2 2.5"/><path d="M17 7.5c1.3 1.3 2 2.8 2 4.5s-.7 3.2-2 4.5"/>'],
  lock:    ['#8a6d3b', '<rect x="7" y="11" width="10" height="8" rx="1.5"/><path d="M9 11V8a3 3 0 0 1 6 0v3"/>'],
  copy:    ['#4f86c6', '<rect x="8" y="8" width="10" height="12" rx="1.5"/><path d="M6 16V6.5A1.5 1.5 0 0 1 7.5 5H16"/>'],
  send:    ['#3a9d97', '<path d="M4 12l16-7-4 16-4-7z"/><path d="M20 5l-8 7"/>'],
  close:   ['#d8635e', '<path d="M7 7l10 10"/><path d="M17 7l-10 10"/>'],
  pencil:  ['#cf9a36', '<path d="M15.2 4.8a2 2 0 0 1 2.8 0l1.2 1.2a2 2 0 0 1 0 2.8L8.5 19.5 4 20.5l1-4.5z"/><path d="M14 6l4 4"/>'],
  dna:     ['#8f6cc4', '<path d="M8 4v16"/><path d="M16 4v16"/><path d="M8 7c2.7 1.5 5.3 1.5 8 0"/><path d="M8 12c2.7-1.5 5.3-1.5 8 0"/><path d="M8 17c2.7 1.5 5.3 1.5 8 0"/>'],
  medical: ['#d8635e', '<path d="M12 4v16"/><path d="M4 12h16"/><circle cx="12" cy="12" r="9" stroke-dasharray="2 2"/>'],
  pray:    ['#cf9a36', '<path d="M12 4v5"/><path d="M8 9c0 0 1 3 4 6 3-3 4-6 4-6"/><path d="M8 9l-2 7h12l-2-7"/><path d="M12 15v5"/>'],
  arrow_back: ['#6783a3', '<path d="M19 12H5"/><path d="M12 5l-7 7 7 7"/>'],
  readbook:['#cf9a36', '<path d="M4 5.5h7v14H4z"/><path d="M13 5.5h7v14h-7z"/><path d="M4 5.5c1.5-.5 3.5-.5 7 1"/><path d="M20 5.5c-1.5-.5-3.5-.5-7 1"/><path d="M11 6.5v14"/><path d="M13 6.5v14"/>'],
  // ── Подсказки на главной ──
  feat_term:   ['#4f86c6', '<path d="M9 6h6"/><path d="M12 6v9"/><path d="M9.5 15h5"/><circle cx="17" cy="16" r="2.4"/><path d="M18.7 17.7L21 20"/>'],
  feat_search: ['#2b9aa8', '<circle cx="11" cy="11" r="5.2"/><line x1="14.8" y1="14.8" x2="19" y2="19"/>'],
  feat_theme:  ['#8a68c0', '<path d="M16.5 13.2A5.5 5.5 0 0 1 10.8 7.5 5.5 5.5 0 1 0 16.5 13.2z"/>'],
  share:       ['#3a9d97', '<circle cx="7" cy="12" r="2.2"/><circle cx="16.5" cy="6.5" r="2.2"/><circle cx="16.5" cy="17.5" r="2.2"/><path d="M9 11l5.5-3.4"/><path d="M9 13l5.5 3.4"/>'],
  // ── Энциклопедия ──
  ...
  // ── Расписание питания ──
  ft_dairy:  ['#cf9a36', '<path d="M8 5h8l-1 14H9L8 5z"/><path d="M7 5h10"/><path d="M10 9c0 1 1 2 2 2s2-1 2-2"/>'],
  ft_spice:  ['#5aa85d', '<path d="M12 4v8"/><path d="M12 12c-2.5 0-5-2-5-5 2.5 0 5 2 5 5z"/><path d="M12 12c2-1.5 4-4 4-6.5-2.5.5-4 3-4 6.5z"/><path d="M8 18h8"/><path d="M9 15c1 2 2 3 3 3s2-1 3-3"/>'],
  ft_fruit:  ['#d8635e', '<circle cx="12" cy="13" r="5"/><path d="M12 8V6"/><path d="M10 6c1-1 3-1 4 0"/>'],
  ft_oil:    ['#e0852f', '<path d="M10 4h4l1 4H9l1-4z"/><path d="M9 8v10c0 1 1.3 2 3 2s3-1 3-2V8"/>'],
  ft_nuts:   ['#b9803c', '<ellipse cx="12" cy="13" rx="4" ry="5"/><path d="M12 8v10"/><path d="M8.5 11c2 1 5 1 7 0"/>'],
  ft_veggie: ['#5a9e3f', '<path d="M12 19v-7"/><path d="M8 12c0-3 1.8-5 4-5s4 2 4 5"/><path d="M9 8c1-2 2-3 3-3s2 1 3 3"/>'],
  ft_grain:  ['#cf9a36', '<path d="M7 17h10"/><path d="M8 14c0-3 1.8-5.5 4-5.5s4 2.5 4 5.5"/><path d="M12 8.5V6"/><path d="M10 7l2-1 2 1"/>'],
  ft_drink:  ['#5ab5cf', '<path d="M8 5h8l-2 14h-4L8 5z"/><path d="M7 5h10"/><path d="M10 11h4"/>'],
  ft_shroom: ['#8a6d3b', '<path d="M12 13v6"/><path d="M9 19h6"/><path d="M6 13c0-4 2.7-7 6-7s6 3 6 7H6z"/>'],
};
