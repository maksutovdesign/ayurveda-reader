import { BOOKS, loadBookData, configureContent } from './books.js?v=400';
import { GLOSSARY, lookupTerm, TERM_REGEX } from './glossary.js';
import { DISEASES, getDiseaseCategories } from './diseases.js?v=400';
import { QUIZ } from './quiz.js';
import { FOOD_TABLE } from './foodtable.js';
import * as Cabinet from './cabinet.js?v=400';
import { icon } from './icons.js?v=400';
...
async function ensureEncyclopedia() {
  ...
  const m = await import('./encyclopedia.js?v=400');
...
async function ensureRemedies() {
  ...
  const m = await import('./remedies.js?v=400');
