import { BOOKS, loadBookData, configureContent } from './books.js?v=376';
import { GLOSSARY, lookupTerm, TERM_REGEX } from './glossary.js';
import { DISEASES, getDiseaseCategories } from './diseases.js?v=376';
import { QUIZ } from './quiz.js';
import { FOOD_TABLE } from './foodtable.js';
import * as Cabinet from './cabinet.js?v=376';
import { icon } from './icons.js?v=376';
...
async function ensureEncyclopedia() {
  ...
  const m = await import('./encyclopedia.js?v=376');
...
async function ensureRemedies() {
  ...
  const m = await import('./remedies.js?v=376');
