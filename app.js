import { BOOKS, loadBookData, configureContent } from './books.js?v=363';
import { GLOSSARY, lookupTerm, TERM_REGEX } from './glossary.js';
import { DISEASES, getDiseaseCategories } from './diseases.js?v=363';
import { QUIZ } from './quiz.js';
import { FOOD_TABLE } from './foodtable.js';
import * as Cabinet from './cabinet.js?v=363';
import { icon } from './icons.js?v=363';
...
async function ensureEncyclopedia() {
  ...
  const m = await import('./encyclopedia.js?v=363');
...
async function ensureRemedies() {
  ...
  const m = await import('./remedies.js?v=363');
