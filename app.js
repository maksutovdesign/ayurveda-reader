import { BOOKS, loadBookData, configureContent } from './books.js?v=405';
import { GLOSSARY, lookupTerm, TERM_REGEX } from './glossary.js';
import { DISEASES, getDiseaseCategories } from './diseases.js?v=405';
import { QUIZ } from './quiz.js';
import { FOOD_TABLE } from './foodtable.js';
import * as Cabinet from './cabinet.js?v=405';
import { icon } from './icons.js?v=405';
...
async function ensureEncyclopedia() {
  ...
  const m = await import('./encyclopedia.js?v=405');
...
async function ensureRemedies() {
  ...
  const m = await import('./remedies.js?v=405');
